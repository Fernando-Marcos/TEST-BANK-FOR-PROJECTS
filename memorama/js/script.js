/*
<!--
    Programado por Fernando Marcos 
    Contacto:   https://fernandomarcos.com
-->
*/
...
new Vue({
    ...
    data: () => ({
        ...
        imagenes: [
            "./img/knoelig-bolsa.jpg",
            "./img/huvudroll-mesne.jpg",
            "./img/markus-silla-trabajo.jpg",
            "./img/evedal-lampara-mesa.jpg",
            "./img/brimnes-comoda.jpg",
            "./img/sinnlig-vela-aromatica.jpg",
        ],
        memorama: [],
    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                ...
                html: `
                <br>
                Te agradezco el tiempo invertido
                <br>
                en revisar mi perfil profesional 
                <br>
                para optar al proceso de selección
                <br>
                del puesto de Maquinista de Almacén,
                <br>
                u otro que se adecúe vuestras 
                <br>
                necesidades y a mis conocimientos.
                <br>
                <br>
                <strong>TACK!</strong>
                <br>
                <br>
                Creado con 💙 por <a href="https://www.linkedin.com/in/fernando-marcos/">Fernando Marcos</a>
                </div>
                `,
        ...
        indicarVictoria() {
            Swal.fire({
                ...
                <p class="h4">Ahora... contacta conmigo 😀<br> 691 40 29 92 (Fernando)</p>`,
                    confirmButtonText: "Jugar de nuevo",
                    allowOutsideClick: false,
                    allowEscapeKey: false,
                })
